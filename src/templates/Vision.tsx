  ...
  >
    <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-lg bg-white p-8 shadow-lg">
        ...
        <p className="leading-relaxed text-gray-600">
          نلتزم ببناء مساكن بجودة عالية وتصميم عصري رائع، تحقق جميع المتطلبات
          والاشتراطات للأهالي، وتوفر لهم سكناً مريحاً وجميلاً يتوافق مع هويتنا
          السعودية.
        </p>
      </div>
      ...
      <div className="rounded-lg bg-white p-8 shadow-lg">
        ...
        <p className="leading-relaxed text-gray-600">
          نهدف إلى أن نكون قريبين من الشباب السعودي، ونبني لهم مساكن تناسب
          تطلعاتهم وتتوافق مع هويتهم وثقافتهم، دون الخروج عن قيمنا ومبادئنا
          الأصيلة.
        </p>
      </div>
    </div>
